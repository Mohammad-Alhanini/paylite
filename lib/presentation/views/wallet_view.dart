...
// import 'package:payliteapp/presentation/viewmodels/auth_viewmodel.dart';
// import 'package:payliteapp/presentation/viewmodels/wallet_viewmodel.dart';
// import 'package:payliteapp/presentation/views/login_view.dart';
// import 'package:payliteapp/presentation/views/transfer_view.dart';
// import 'package:payliteapp/presentation/widgets/custom_button%20.dart';
// import 'package:payliteapp/presentation/widgets/loading_overlay.dart';
...
//               ),
//               const SizedBox(height: 10),
//               if (walletVM.recent.isEmpty) const Text('No transactions yet'),
//               ...walletVM.recent.map(
//                 (tx) => ListTile(
//                   title: Text(tx.recipientEmail),
//                   subtitle: Text(tx.createdAt.toString()),
//                   trailing: Text(
//                     '${tx.amount.toStringAsFixed(2)} JOD',
